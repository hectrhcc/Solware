  ...
  return (
    <section className="hero-320-fix hero min-h-screen mb-0 pb-0 w-full bg-white px-6 flex flex-row items-center justify-between gap-0 lg:gap-20 md:gap-9 overflow-hidden ">
      ...
      <div className="w-1/2 md:w-2/3 lg:w-1/2 text-left " >
        <h1 className="hero-320-fix text-3xl lg:relative md:left-8 md:relative lg:left-30 lg:bottom-1 md:text-4xl lg:text-6xl font-bold text-gray-900 leading-tight" data-aos="fade-up">
          Desarrollamos el <span className="text-[#0D206C]">sitio web </span><br className='lg:hidden'/>
          que tu negocio necesita
        </h1>
        <p className="hero-320-fix mt-4 text-md md:w-9/10 md:text-xl lg:text-2xl lg:bottom-1 md:left-8 md:relative  text-gray-600 lg:relative lg:left-30" data-aos="fade-up"> 
      ...
      {/* Logo a la derecha */}
      <div className="relative left-91  md:left-130 w-1/2 md:w-1/3 lg:w-1/2 h-full flex justify-end" data-aos="zoom-in-left">
        <img
          src={solware}
          alt="Solware"
