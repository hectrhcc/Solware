...
<>
 <h1 className='text-2xl md:text-4xl lg:text-5xl font-bold color text-center mt-7 color md:mt-10 mb-5' >PORTAFOLIO</h1>
    ...
    <div className='mt-5 gap-5 flex flex-col lg:flex-row justify-center items-center w-full lg:w-3/4 mx-auto'>    
        <div className='text-sm md:text-lg border-1 w-3/4 lg:w-1/2 p-6 text-center rounded shadow'>web 1</div>
        <div className='text-sm md:text-lg border-1 w-3/4 lg:w-1/2 p-6 text-center rounded shadow'>web 2</div>
        <div className='text-sm md:text-lg border-1 w-3/4 lg:w-1/2 p-6 text-center rounded shadow'>web 3</div>
    </div>  
