...
<>
 <h1 className='text-2xl md:text-4xl lg:text-5xl font-bold color text-center mt-7 color md:mt-10 mb-5' >PORTAFOLIO</h1>
    ...
    <div className='mt-5 gap-5 flex flex-col lg:flex-row justify-center items-center w-full lg:w-3/4 mx-auto ' data-aos="zoom-in">    
        ...
        <img src={tracker} alt='tacker ip' className='w-full h-40 object-cover border-1 border-gray-100  '/>
        <h2 className='text-lg font-semibold color mt-2'>Tracker IP</h2>
        </div>
        <div className='text-sm md:text-lg  w-3/4 lg:w-1/2 text-center border-1 border-gray-800  pt-6 pb-6 ounded shadow transform transition-transform duration-300 hover:scale-105 '>
        ...
        <div className='text-sm md:text-lg border-1 w-3/4 lg:w-1/2   border-gray-800 pt-6 pb-6 text-center rounded shadow transform transition-transform duration-300 hover:scale-105 '>
